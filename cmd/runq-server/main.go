// runq-server is the headless execution daemon for machines that own GPUs
...
// account is your identity, and runq-server never grows auth code of its own.
//
...
func main() {
	...
	if err != nil {
		_, _ = fmt.Fprintln(os.Stderr, "runq-server:", err)
		os.Exit(1)
	}
